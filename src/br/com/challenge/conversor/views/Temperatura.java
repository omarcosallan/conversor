...
import br.com.challenge.controller.ControllerTemperatura;
...
public class Temperatura extends JFrame {
	...
	public Temperatura() {
		...
		JLabel lblNewLabel = new JLabel("Estou pronto para converter temperaturas");
		...
		String[] opcoes = Conversores.TEMPERATURA.getOpcoes();
		...
		btnConverter.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
					ControllerTemperatura controllerTemperatura = new ControllerTemperatura();
					String valor = txtValor.getText();
					txtResultado.setText(
							"Conversão: " + controllerTemperatura.converteTemperaturas(valor, conversores.getSelectedItem().toString()));
